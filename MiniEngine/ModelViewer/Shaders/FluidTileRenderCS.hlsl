...
//    g_OutputColorBuffer[ST] = float3(1.f, 1.f, 1.f); // Color.rgb + DestColor * (1.0 - Color.a);
//#else
//    float3 DestColor = Unpack_R11G11B10_FLOAT(g_OutputColorBuffer[ST]);
//    g_OutputColorBuffer[ST] = Pack_R11G11B10_FLOAT(float3(1.f, 1.f, 1.f)); //Color.rgb + DestColor * (1.0 - Color.a));
//#endif
