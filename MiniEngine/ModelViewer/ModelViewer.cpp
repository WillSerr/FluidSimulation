...
void ModelViewer::Startup( void )
{
    ...
    FluidEffectManager::Initialize(3840, 2160);
    ...
    else
    {
        ...
        m_ModelInst.Resize(180.0f);

        const Vector3 eye = Vector3(0.0f, 0.0f, 122.f);
        m_Camera.SetEyeAtUp(eye, Vector3(kZero), Vector3(kYUnitVector));
    ...
    FluidEffectProperties fluidEffect;

    FluidEffects::InstantiateEffect(fluidEffect);
    //^ Managed Version of these two lines
    //fluidEffect.EmitProperties.TextureID = GetTextureIndex(fluidEffect.TexturePath);
    //FluidEffectManager::InstantiateEffect(fluidEffect);
...
void ModelViewer::RenderScene( void )
{
    ...
    FluidEffectManager::Update(gfxContext.GetComputeContext(), Graphics::GetFrameTime());
    ...
    FluidEffectManager::Render(gfxContext, m_Camera, g_SceneColorBuffer, g_SceneDepthBuffer, g_LinearDepth[FrameIndex]);
